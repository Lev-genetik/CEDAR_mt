...
setwd('/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V5V6')
data=read.table("otu_table_L6.txt", header=T, row.names=1, dec=".", sep="\t")
# data=data[-1,]
...
setwd('/media/lev-genetik/980E73270E72FD96/Liege/Results/Enterotyping/2018_09_06_enterotyping/Graphs/V5V6')
jpeg(filename = 'CH_Opt_number_clust_for_L6_new.jpg')
plot(nclusters, type="h", xlab="Number of clusters", ylab="CH index",main="Calinski-Harabasz pseudo F-statistic", lwd=2, cex.lab=1)
dev.off()
jpeg(filename = 'Silhouettes_Opt_number_clust_for_L6_new.jpg')
