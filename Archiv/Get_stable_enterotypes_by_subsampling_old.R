# This is a program to get percentage of enterotype probability of samples based on the taxa abundance table
...
# The program to check how the probability of getting v12-v34-v56 stable enterotype (file2) depending on 
...
# graph.file = 'v1v2_ent_probability_by_sampl_vs_v12v34v56.jpg' - need to change depending on amplicon 
# obtained by getStablEntSubsampl function
...
subsVsLoc <- function(file1 = '/media/lev-genetik/980E73270E72FD96/Liege/Results/Enterotyping/2018_09_06_enterotyping/Sample-enterotype/Enterotype_Probabilities/V1V2_3e_sample-enterotype_probabilities.csv',file2='/media/lev-genetik/980E73270E72FD96/Liege/Results/Enterotyping/2018_09_06_enterotyping/Sample-enterotype/Stable_enterotypes.csv', folder = '/media/lev-genetik/980E73270E72FD96/Liege/Results/Enterotyping/2018_09_06_enterotyping/Sample-enterotype/Enterotype_Probabilities/Graphs_enterotype_probability',graph.file = 'v1v2_ent_probability_by_sampl_vs_v12v34v56.jpg',window=200){
  ...
  probability.window <- rollmean(identity.vector,k=window)
  ...
  plot(probability.window, xlab = 'Sample enterotype probability index in descend order', ylab = ylab1)
  dev.off
}
