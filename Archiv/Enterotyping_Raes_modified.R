...
data=read.table("/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/Sample_data_enterotyping/MetaHIT_41SangerSamples.genus.txt", header=T, row.names=1, dec=".", sep="\t")
data=data[-1,]
...
#introducing colors
# cluscol <- function() {
#   if(data.cluster==1){return "blue"}
#   else if (data.cluster==2){return "red"}
#   else if (data.cluster==3){return "green"}
#   else {return "purple"}
# }
