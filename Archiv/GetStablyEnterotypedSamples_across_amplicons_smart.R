...
getStabAcrAmpl <- function(file1, file2, file3, correspondence=NA, files=TRUE){
  library(data.table)
...
# need to correct the row order of corr. As it is inversed in the output of CompEntPred.pair
  ...
  result.v12v34 <- result.v12v34[!result.v12v34[,1]%in%result[,1],]
  result.v12v56 <- result.v12v56[!result.v12v56[,1]%in%result[,1],]
  result.v34v56 <- result.v34v56[!result.v34v56[,1]%in%result[,1],]
  ...
  result.chimera.1234.1256.3456.123456 <- rbind(result.v12v34,result.v12v56,result.v34v56,result)
  ...
  result.total <- list(result.v12v34v56,result.v12v34,result.v12v56,result.v34v56,result.nonconserved)
  names(result.total) <- c('result.v12v34v56','result.v12v34','result.v12v56','result.v34v56','result.nonconserved')
  return(result.total)
}
