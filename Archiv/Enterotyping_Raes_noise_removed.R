...
jpeg(filename = '/media/lev-genetik/980E73270E72FD96/Liege/Results/Clustering/Genus_level/CH_Opt_number_clust_for_L6.jpg')
plot(nclusters, type="h", xlab="Number of clusters", ylab="CH index",main="Calinski-Harabasz pseudo F-statistic", lwd=2, cex.lab=1)
dev.off()
jpeg(filename = '/media/lev-genetik/980E73270E72FD96/Liege/Results/Clustering/Genus_level/Silhouettes_Opt_number_clust_for_L6.jpg')
...
## plot 1
obs.pca=dudi.pca(data.frame(t(data)), scannf=T, nf=10)
