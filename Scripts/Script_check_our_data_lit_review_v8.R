...
source(paste0(progr.dir,'/Check_data_lit_review_v5.R'))
# here are taxa and ther=ir representation different representation across amplicons
diff12 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'),
                              sample.cov.filter=c(23000,13000), select.taxa = 't-test')
diff13 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                              sample.cov.filter=c(23000,21000), select.taxa = 't-test')
diff23 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                              sample.cov.filter=c(13000,21000), select.taxa = 't-test')
# all taxa and their representation across amplicons
all12 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'),
                              sample.cov.filter=c(23000,13000), select.taxa = 'all')
all13 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                              sample.cov.filter=c(23000,21000), select.taxa = 'all')
all23 <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'), 
                              file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                              sample.cov.filter=c(13000,21000), select.taxa = 'all')
...
diff12.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(23000,13000), select.taxa = 't-test')
diff13.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(23000,21000), select.taxa = 't-test')
diff23.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(13000,21000), select.taxa = 't-test')
all12.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(23000,13000), select.taxa = 'all')
all13.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V1V2/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(23000,21000), select.taxa = 'all')
all23.lg <- checkTaxaAcrossAmpl(file1 = paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt'), 
                                 file2=paste0(home.dir,'/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt'),
                                 log.scale = T,sample.cov.filter=c(13000,21000), select.taxa = 'all')
...
# 8c. Plot all taxa fraction across amplicons pairwise
# NB First, run 8a!
setwd(paste0(home.dir,'/Results/Check_liter_review/Amplicon_difference_detect_taxa'))

# prepare data for all 3 amplicon pairs
to.plot.all12.lg <- all12.lg[,1:2]
rownames(to.plot.all12.lg) <- word(rownames(all12.lg),start = -2, end=-1, sep='__')
to.plot.diff12.lg <- diff12.lg[abs(diff12.lg[,3])>=1|diff12.lg[,1]>=-2|diff12.lg[,2]>=-2,1:2]
rownames(to.plot.diff12.lg) <- word(rownames(diff12.lg[abs(diff12.lg[,3])>=1|diff12.lg[,1]>=-2|diff12.lg[,2]>=-2,]),start = -2, end=-1, sep='__')
labels.12 <- seq(1,dim(to.plot.diff12.lg)[1],by=1)
to.plot.all13.lg <- all13.lg[,1:2]
rownames(to.plot.all13.lg) <- word(rownames(all13.lg),start = -2, end=-1, sep='__')
to.plot.diff13.lg <- diff13.lg[abs(diff13.lg[,3])>=1|diff13.lg[,1]>=-2|diff13.lg[,2]>=-2,1:2]
rownames(to.plot.diff13.lg) <- word(rownames(diff13.lg[abs(diff13.lg[,3])>=1|diff13.lg[,1]>=-2|diff13.lg[,2]>=-2,]),start = -2, end=-1, sep='__')
labels.13 <- seq(1,dim(to.plot.diff13.lg)[1],by=1)
to.plot.all23.lg <- all23.lg[,1:2]
rownames(to.plot.all23.lg) <- word(rownames(all23.lg),start = -2, end=-1, sep='__')
to.plot.diff23.lg <- diff23.lg[abs(diff23.lg[,3])>=1|diff23.lg[,1]>=-2|diff23.lg[,2]>=-2,1:2]
rownames(to.plot.diff23.lg) <- word(rownames(diff23.lg[abs(diff23.lg[,3])>=1|diff23.lg[,1]>=-2|diff23.lg[,2]>=-2,]),start = -2, end=-1, sep='__')
labels.23 <- seq(1,dim(to.plot.diff23.lg)[1],by=1)

# V12 vs V34
jpeg('v12-v34_log10_all.jpg',width = 1200,height = 1200)
par(mar=c(7,7,7,2))
plot(to.plot.all12.lg,main='v1v2 vs v3v4 taxa average fraction',xlim = c(-8,0),ylim = c(-8,0),
     xlab = expression('v1v2 taxa average fraction across samples, log'[10]*' scale'), 
     ylab = expression('v3v4 taxa average fraction across samples, log'[10]*' scale'),
     cex.main=5,cex.lab=3,cex.axis=2, col='darkblue',pch=20)
lines(rbind(c(1,1),c(-13,-13)),col = 'green')
lines(rbind(c(0,1),c(-14,-13)),col = 'orange')
lines(rbind(c(1,0),c(-13,-14)),col = 'orange')
grid(lwd=3)
text(x=to.plot.diff12.lg[,1],y=to.plot.diff12.lg[,2],labels = labels.12,cex=2.5,col='black',pos = 3)
points(all12.lg[,1:2],cex=4,col='darkblue',pch=20)
points(diff12.lg[abs(diff12.lg[,3])<=1,1:2],cex=4,col='orange',pch=20)
points(diff12.lg[abs(diff12.lg[,3])>1,1:2],cex=4,col='red',pch=20)
dev.off()
legend12 = paste0(labels.12,'=',rownames(to.plot.diff12.lg),'\n')
cat(legend12)
# V12 vs v56
jpeg('v12-v56_log10_all.jpg',width = 1200,height = 1200)
par(mar=c(7,7,7,2))
plot(to.plot.all13.lg,main='v1v2 vs v5v6 taxa average fraction',xlim = c(-8,0),ylim = c(-8,0),
     xlab = expression('v1v2 taxa average fraction across samples, log'[10]*' scale'), 
     ylab = expression('v5v6 taxa average fraction across samples, log'[10]*' scale'),
     cex.main=5,cex.lab=3,cex.axis=2, col='darkblue',pch=20)
lines(rbind(c(1,1),c(-13,-13)),col = 'green')
lines(rbind(c(0,1),c(-14,-13)),col = 'orange')
lines(rbind(c(1,0),c(-13,-14)),col = 'orange')
grid(lwd=3)
text(x=to.plot.diff13.lg[,1],y=to.plot.diff13.lg[,2],labels = labels.13,cex=2.5,col='black',pos = 3)
points(all13.lg[,1:2],cex=4,col='darkblue',pch=20)
points(diff13.lg[abs(diff13.lg[,3])<=1,1:2],cex=4,col='orange',pch=20)
points(diff13.lg[abs(diff13.lg[,3])>1,1:2],cex=4,col='red',pch=20)
dev.off()
legend13 = paste0(labels.13,'=',rownames(to.plot.diff13.lg),'\n')
cat(legend13)
# v34 vs v56
jpeg('v34-v56_log10_all.jpg',width = 1200,height = 1200)
par(mar=c(7,7,7,2))
plot(to.plot.all23.lg,main='v3v4 vs v5v6 taxa average fraction',xlim = c(-8,0),ylim = c(-8,0),
     xlab = expression('v3v4 taxa average fraction across samples, log'[10]*' scale'), 
     ylab = expression('v5v6 taxa average fraction across samples, log'[10]*' scale'),
     cex.main=5,cex.lab=3,cex.axis=2, col='darkblue',pch=20)
lines(rbind(c(1,1),c(-13,-13)),col = 'green')
lines(rbind(c(0,1),c(-14,-13)),col = 'orange')
...
grid(lwd=3)
text(x=to.plot.diff23.lg[,1],y=to.plot.diff23.lg[,2],labels = labels.23,cex=2.5,col='black',pos = 3)
points(all23.lg[,1:2],cex=4,col='darkblue',pch=20)
points(diff23.lg[abs(diff23.lg[,3])<=1,1:2],cex=4,col='orange',pch=20)
points(diff23.lg[abs(diff23.lg[,3])>1,1:2],cex=4,col='red',pch=20)
dev.off()
legend23 = paste0(labels.23,'=',rownames(to.plot.diff23.lg),'\n')
cat(legend23)
