...
dev.off()
# # V3V4
# jpeg('v3v4_samples_microbiota_coverage_stats_10k.jpg',width = 1600,height = 1600)
# par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
# for (i in locations){
#   exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V3V4/otu_table_L6.txt',
#                         locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,usredneniye=20)
...
# dev.off()
# # V5V6
# jpeg('v5v6_samples_microbiota_coverage_stats_10k.jpg',width = 1600,height = 1600)
# par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
# for (i in locations){
#   exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V5V6/otu_table_L6.txt',
#                         locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,usredneniye=20)
...
# 6b. Plot all reads' number (unfiltered reads from Natalia)

source('/home/lev-genetik/Desktop/Projects/liege/src/Lev/Check_data_lit_review_v3.R')
setwd('/media/lev-genetik/980E73270E72FD96/Liege/Results/Check_liter_review/Sample_coverage')
# First for coverage window +-10k reads (e.g. 0 to 19,999) (usredneniye=20)
# V1V2
jpeg('v1v2_samples_total_coverage_stats_10k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V1V2/stats_v12.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
                        usredneniye=20)
}
dev.off()
# V3V4
jpeg('v3v4_samples_total_coverage_stats_10k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V3V4/stats_v34.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
                        usredneniye=20)
}
dev.off()
# V5V6
jpeg('v5v6_samples_total_coverage_stats_10k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V5V6/stats_v56.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
                        usredneniye=20)
}
dev.off()
# Now for coverage window +-1k reads (e.g. 0 to 1999) - we change only usredneniye=2
# V1V2
jpeg('v1v2_samples_total_coverage_stats_1k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V1V2/stats_v12.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
...
dev.off()
# V3V4
jpeg('v3v4_samples_total_coverage_stats_1k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V3V4/stats_v34.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
...
dev.off()
# V5V6
jpeg('v5v6_samples_total_coverage_stats_1k.jpg',width = 1600,height = 1600)
par(mfrow=c(2,2),mar = c(8,10,7,5), mgp=c(6,2,0))
for (i in locations){
  exploreCoverage(input_file = '/media/lev-genetik/980E73270E72FD96/Liege/Work_dir/DATA/summarize_taxa_counts/V5V6/stats_v56.txt',
                        locat = i, percent_threshold = 0, remove.outliers = 0,cumulative=FALSE,input_type='total.coverage',
