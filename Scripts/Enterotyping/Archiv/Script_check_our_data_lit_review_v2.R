...
# 2. WITHOUT BACTEROIDES AND PREVOTELLA Check the hypothesis that without Bacteroides and Prevotella, samples would not cluster
...
# BACTEROIDES TO PREVOTELLA RATIO draw Bacteroides to Prevotella ratio
setwd('/media/lev-genetik/980E73270E72FD96/Liege/Results/Check_liter_review')
...
BactPrev_v1v2b <- v1v2_table[rownames(v1v2_table)%like%'g__Bacteroides',]
BactPrev_v1v2p <- v1v2_table[rownames(v1v2_table)%like%'g__Prevotella',]
...
jpeg('v1v2_Bact_Prev_ratio_density.jpg',width = 800,height = 600)
plot(density(na.omit(BactPrev_v1v2r_log)),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v1v2_Bact_Prev_ratio_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(na.omit(BactPrev_v1v2r_log[names(BactPrev_v1v2r_log)%like%i])),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
  dev.off()
}
jpeg('v1v2_Bact_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v1v2b)),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v1v2_Bact_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v1v2b[names(BactPrev_v1v2b)%like%i])),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
  dev.off()
}
jpeg('v1v2_Prev_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v1v2p)),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v1v2_Prev_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v1v2p[names(BactPrev_v1v2p)%like%i])),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
  dev.off()
}
...
BactPrev_v3v4b <- v3v4_table[rownames(v3v4_table)%like%'g__Bacteroides',]
BactPrev_v3v4p <- v3v4_table[rownames(v3v4_table)%like%'g__Prevotella',]
...
jpeg('v3v4_Bact_Prev_ratio_density.jpg',width = 800,height = 600)
plot(density(na.omit(BactPrev_v3v4r_log)),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
dev.off()
names(BactPrev_v3v4r_log) <- names(BactPrev_v3v4b)
# now for locations separately
for (i in locations){
  file_name <- paste0('v3v4_Bact_Prev_ratio_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(na.omit(BactPrev_v3v4r_log[names(BactPrev_v3v4r_log)%like%i])),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
  dev.off()
}
jpeg('v3v4_Bact_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v3v4b)),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v3v4_Bact_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v3v4b[names(BactPrev_v3v4b)%like%i])),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
  dev.off()
}
jpeg('v3v4_Prev_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v3v4p)),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v3v4_Prev_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v3v4p[names(BactPrev_v3v4p)%like%i])),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
  dev.off()
}
# v5v6
...
BactPrev_v5v6b <- v5v6_table[rownames(v5v6_table)%like%'g__Bacteroides',]
BactPrev_v5v6p <- v5v6_table[rownames(v5v6_table)%like%'g__Prevotella',]
...
jpeg('v5v6_Bact_Prev_ratio_density.jpg',width = 800,height = 600)
plot(density(na.omit(BactPrev_v5v6r_log)),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
dev.off()
names(BactPrev_v5v6r_log) <- names(BactPrev_v3v4b)
# now for locations separately
for (i in locations){
  file_name <- paste0('v5v6_Bact_Prev_ratio_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(na.omit(BactPrev_v5v6r_log[names(BactPrev_v5v6r_log)%like%i])),main='Bacteroides/Prevotella ratio',xlab = 'Bacteroides/Prevotella, log scale')
  dev.off()
}
jpeg('v5v6_Bact_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v5v6b)),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
dev.off()
for (i in locations){
  file_name <- paste0('v5v6_Bact_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v5v6b[names(BactPrev_v5v6b)%like%i])),main='Bacteroides abundance',xlab = 'Bacteroides abundance, read counts')
  dev.off()
}
jpeg('v5v6_Prev_abundance_density.jpg',width = 800,height = 600)
plot(density(as.numeric(BactPrev_v5v6p)),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
dev.off()
# now for locations separately
for (i in locations){
  file_name <- paste0('v5v6_Prev_abundance_density_loc_',str_sub(i,start=3),'.jpg')
  jpeg(file_name,width = 800,height = 600)
  plot(density(as.numeric(BactPrev_v5v6p[names(BactPrev_v5v6p)%like%i])),main='Prevotella abundance',xlab = 'Prevotella abundance, read counts')
  dev.off()
}

# Now the same program but draw plots in one file
# V1V2
# draw Bacteroides to Prevotella ratio
...
for (i in locations){
  j = i
  if (i==''){j <- '__all loc'}
  plot(density(na.omit(BactPrev_v1v2r_log[names(BactPrev_v1v2r_log)%like%i])),main=paste0('Bacteroides/Prevotella rat. ',str_sub(j,start=3)),xlab = 'log(Bacteroides/Prevotella)',cex.main = 5,cex.lab = 4, cex.axis = 2)
  grid(nx=10,lty = 6)
}
dev.off()
...
for (i in locations){
  j = i
  if (i==''){j <- '__all loc'}
  plot(density(as.numeric(BactPrev_v1v2b[names(BactPrev_v1v2b)%like%i])),main=paste0('Bacteroides abundance ',str_sub(j,start=3)),xlab = 'Bacteroides abundance',cex.main = 5,cex.lab = 4, cex.axis = 2)
  grid(nx=10,lty = 6)
}
dev.off()
...
for (i in locations){
  j = i
  if (i==''){j <- '__all loc'}
  plot(density(as.numeric(BactPrev_v1v2p[names(BactPrev_v1v2p)%like%i])),main=paste0('Prevotella abundance ',str_sub(j,start=3)),xlab = 'Prevotella abundance',cex.main = 5,cex.lab = 4, cex.axis = 2)
  grid(nx=10,lty = 6)
}
dev.off()
...
# do some calculations based on v1v2
...
# compare IL, TR and RE in alpha and beta diversity
...
# make plots of species vs % hreshold
