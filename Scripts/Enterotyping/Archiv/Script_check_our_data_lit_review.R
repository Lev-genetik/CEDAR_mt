...
# 1. According to Arumigam 2011, Costea 2018, the enterotypes they get are
...
# 2. Check the hypothesis that without Bacteroides and Prevotella, samples would not cluster
...
alpha_diversity <- matrix(0,3,3)
colnames(alpha_diversity) <- c('IL','TR','RE')
rownames(alpha_diversity) <- c('0.005%','0.01%','0.02%')
...
# IL vs TR
IL.unique.comp.to.TR <- setdiff(species.v56.IL.002,species.v56.TR.0005)
TR.unique.comp.to.IL <- setdiff(species.v56.TR.002,species.v56.IL.0005)
# IL vs TR
IL.unique.comp.to.RE <- setdiff(species.v56.IL.002,species.v56.RE.0005)
RE.unique.comp.to.IL <- setdiff(species.v56.RE.002,species.v56.IL.0005)
# TR vs RE
TR.unique.comp.to.RE <- setdiff(species.v56.TR.002,species.v56.RE.0005)
RE.unique.comp.to.TR <- setdiff(species.v56.RE.002,species.v56.TR.0005)
