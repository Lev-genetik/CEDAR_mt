...
# 5. Now, to determine the filtration threshold most precisely, we need to compare graphs for different rolling window size
...
#6. determine fraction of stable and unstable samples among good covered vs poor covered at least in 1 amplicon
source(file.path(progr.dir,'/GetEnterotype_consistency_coverage_cutoff.R'))
# all locations
getEnterotypeConsistCoverCutoff(locat='all',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_06_enterotyping/Sample-enterotype/Stable_enterotypes.csv'),
                                thresholds=c(19000,10000,20000))
# IL
getEnterotypeConsistCoverCutoff(locat='.IL',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_IL.csv'),
                                thresholds=c(19000,12000,25000))
# TR
getEnterotypeConsistCoverCutoff(locat='.TR',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_TR.csv'),
                                thresholds=c(24000,15000,20000))
# RE
getEnterotypeConsistCoverCutoff(locat='.RE',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_RE.csv'),
                                thresholds=c(23000,14000,22000))
# 7. Try to change cov thresholds for IL and see the results
# cutpoint set I. 
# IL
getEnterotypeConsistCoverCutoff(locat='.IL',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_IL.csv'),
                                thresholds=c(34000,20000,39000))


# cutpoint set II.
data_v12_IL <- readQiimeSmart(input_file = qiime_file_v12, locat = '.IL', percent_threshold = 0, remove.outliers = 0,to.scale = FALSE)
colnames(data_v12_IL) <- gsub('.V[0-9][0-9]','',colnames(data_v12_IL))
data_v12_IL.poor <- union(colnames(data_v12_IL[,colSums(data_v12_IL)<19000]),colnames(data_v12_IL[,colSums(data_v12_IL)>85000]))
data_v12_IL.good <- intersect(colnames(data_v12_IL[,colSums(data_v12_IL)>=19000]), colnames(data_v12_IL[,colSums(data_v12_IL)<=85000]))
data_v12.poor <- list(data_v12_all.poor,data_v12_IL.poor,data_v12_TR.poor,data_v12_RE.poor)
data_v12.good <- list(data_v12_all.good,data_v12_IL.good,data_v12_TR.good,data_v12_RE.good)
...
data_v34_IL <- readQiimeSmart(input_file = qiime_file_v34, locat = '.IL', percent_threshold = 0, remove.outliers = 0,to.scale = FALSE)
colnames(data_v34_IL) <- gsub('.V[0-9][0-9]','',colnames(data_v34_IL))
data_v34_IL.poor <- union(colnames(data_v34_IL[,colSums(data_v34_IL)<12000]),colnames(data_v34_IL[,colSums(data_v34_IL)>83000]))
data_v34_IL.good <- intersect(colnames(data_v34_IL[,colSums(data_v34_IL)>=12000]), colnames(data_v34_IL[,colSums(data_v34_IL)<=83000]))
data_v34_TR <- readQiimeSmart(input_file = qiime_file_v34, locat = '.TR', percent_threshold = 0, remove.outliers = 0,to.scale = FALSE)
data_v34.poor <- list(data_v34_all.poor,data_v34_IL.poor,data_v34_TR.poor,data_v34_RE.poor)
data_v34.good <- list(data_v34_all.good,data_v34_IL.good,data_v34_TR.good,data_v34_RE.good)
...
# cutpoint set III. 
# Smth damaged here but I have the results already. So long because also max cov cutpoint introduced.
# v1v2
data_v12_all <- readQiimeSmart(input_file = qiime_file_v12, locat = 'all', percent_threshold = 0, remove.outliers = 0,to.scale = FALSE)
colnames(data_v12_all) <- gsub('.V[0-9][0-9]','',colnames(data_v12_all))
...
# cutpoint set IV = the best
# (made from again by eye from the graphs Script_coverage_vs_enterotype_stability #5 program)
# all locations
getEnterotypeConsistCoverCutoff(locat='all',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_06_enterotyping/Sample-enterotype/Stable_enterotypes.csv'),
                                thresholds=c(23000,13000,21000))
# IL
getEnterotypeConsistCoverCutoff(locat='.IL',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_IL.csv'),
                                thresholds=c(17000,12000,25000))
# TR
getEnterotypeConsistCoverCutoff(locat='.TR',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_TR.csv'),
                                thresholds=c(24000,15000,17000))
# RE
getEnterotypeConsistCoverCutoff(locat='.RE',stable_enterotype_file=file.path(home.dir,'/Results/Enterotyping/2018_09_26_sep_ent_by_location/Sample-enterotype/Old-the-same/Stable_enterotypes_RE.csv'),
                                thresholds=c(22000,13000,22000))
